...
It looks like mu may have some angle dependence, but it is hard to tell with the 
small number of observations we have here.
...
- E does not seem to have an angle dependence.

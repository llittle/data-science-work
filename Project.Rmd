...
lvl1 <- imported_data_lvl1 %>%
   separate(col = 'X1', into = c('RowID',
            ...
            sep=c(34,
                  ...
                  133,
                  143)) %>%
   separate(col = 'RowID', into = c('Centre, Round',
                                    'FSU Serial number',
                                    'Round',
                                    'Schedule Number',
                                    'Sample',
...
*Not sure why this is not working and is making all of the y valus Na's*
```{r Concat, results = 'hide'}

full_join(lvl1, lvl2, by = 'RowID', keep = TRUE)

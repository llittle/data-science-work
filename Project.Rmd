...
df_all_selected %>% 
   ggplot() +
   geom_point(mapping = aes(x = `Population per sq. km.`, y = `land_area`))+
   geom_smooth(mapping = aes(x = `Population per sq. km.`, y = `land_area`))
```
...
df_all_selected %>% 
   ...
   ggplot(aes(x = `land_area`, y = `Household Expenditure`, color = Rural_Urban)) +
   geom_smooth() + 

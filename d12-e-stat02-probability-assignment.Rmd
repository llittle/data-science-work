...
- I predicted a frequency of 0.5 since in a normal distributon, 50% of the values
are negative
- The value was close to, but not exactly the same as my prediction. As I increase
the number of observations in my sample, the frequency in the sample should 
approach my prediction.
...
- Frequency seems to be approaching .952
...
- My frequency prediction and the calculated probably match up.

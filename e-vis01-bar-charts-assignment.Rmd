...
**Observations**:
- If you don't do a 'dodge' the bars stack, which gives very unrealistic
highway values.
...
**Observations**:
- There are many more SUVs in the dataset than any other car. There are very few
2seaters, and not many minivans either.
...
**Observations**:
- all 2seaters are rear wheel drive
- may SUVs are 4wheel drive
- all pickup trucks are 4wheel drive
- rear wheel drive is not so common
...
V2 had an extra dimension included.
...
**Observations**
- some maufacturers only make one style of car, and most of them make suvs
- the most types of car that any manufacturer makes is 4 - toyata
- seveal manufacturers make 3 styles
